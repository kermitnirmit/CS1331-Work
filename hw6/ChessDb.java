 ...
 * @author nshah372
 * @version 1.0
 * Represents a ChessDb
 */
public class ChessDb {
    /**
     * @param games List of chess Games
     */
    private static List<ChessGame> games;
    /**
     * Constructor for a ChessDb
     *
     */
    public ChessDb() {
        games = new ArrayList<>();
    ...
    /**
     * Adds a game to ChessDb
     * @param g [game to add to ChessDb]
     */
    public static void addGame(ChessGame g) {
        games.add(g);
    }
    /**
     * Getter for games
