...
public class NameParser {
    ...
    public static String getInitials(String realFullName){
        int space=realFullName.indexOf(" ");
        String firstInitial = realFullName.substring(0,1);
        String secondInitial = realFullName.substring(space+1, space+2);
        String realInitials = firstInitial+"."+secondInitial+".";
        return realInitials;
    }
    public static void main(String[] args) {
        ...
        String realFullName=firstName+" "+lastName;
        String initials = getInitials(realFullName);
