...
public class LambdaTroopers {
    ...
    // Comparator<Trooper>
    static interface Bar {   //how do we know whether to use Bar or Comparator?
    ...
    public static void main(String[] args) {
        ...
        //foo((Bar)(Trooper t1, Trooper t2) -> 1);

        // Here we resolve the ambiguity in the overloaded foo() methods?
        //foo((Trooper t1, Trooper t2) ->
        ...
        // Class::staticMethod method reference  //#1 Class:staticMethod
        spurbury.removeIf(Objects::isNull);  //objects is a utlity class
        ...
        superTroopers.removeIf(spurbury::contains);   //object::instanceMethod
        System.out.println("\nJust super troopers:");
        ...
        Comparator<Trooper> byMustacheThenName =
            ...
            Comparator.comparing(Trooper::hasMustache) //#1 Class::instanceMethod
